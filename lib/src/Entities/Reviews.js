...
], Reviews.prototype, "reviews_id", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", Number)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Movies_1.Movies, movies => movies.reviews),
    __metadata("design:type", Movies_1.Movies)
], Reviews.prototype, "movie", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => Users_1.Users, users => users.reviews),
